...
class obj:
    ...
    def set_grid_dsc_array(self, col_dsc: 'int', row_dsc: 'int') -> 'None':
        return _lvgl.lv_obj_set_grid_dsc_array(self._pointer, col_dsc, row_dsc)
    ...
    def get_screen(self) -> 'obj':
        return _lvgl.lv_obj_get_screen(self._pointer)
    def get_display(self) -> 'display':
        return _lvgl.lv_obj_get_display(self._pointer)
    def get_parent(self) -> 'obj':
        return _lvgl.lv_obj_get_parent(self._pointer)
    def get_child(self, idx: 'int') -> 'obj':
        return _lvgl.lv_obj_get_child(self._pointer, idx)
    def get_child_by_type(self, idx: 'int', class_p: 'obj_class') -> 'obj':
        return _lvgl.lv_obj_get_child_by_type(self._pointer, idx, class_p._pointer if class_p else ffi.NULL)
    def get_sibling(self, idx: 'int') -> 'obj':
        return _lvgl.lv_obj_get_sibling(self._pointer, idx)
    def get_sibling_by_type(self, idx: 'int', class_p: 'obj_class') -> 'obj':
        return _lvgl.lv_obj_get_sibling_by_type(self._pointer, idx, class_p._pointer if class_p else ffi.NULL)
    ...
    def tree_walk(self, cb: 'lv_obj_tree_walk_cb_t', user_data: 'None') -> 'None':
    ...
    def get_transform(self) -> 'matrix':
        return _lvgl.lv_obj_get_transform(self._pointer)
    ...
    def transform_point_array(self, points: 'lv_point_t', count: 'size_t', flags: 'OBJ_POINT_TRANSFORM_FLAG') -> 'None':
        return _lvgl.lv_obj_transform_point_array(self._pointer, points, count, flags.value if flags else 0)
    ...
    def get_local_style_prop(self, prop: 'lv_style_prop_t', value: 'lv_style_value_t', selector: 'lv_style_selector_t') -> 'lv_style_res_t':
        return _lvgl.lv_obj_get_local_style_prop(self._pointer, prop, value, selector)
    ...
    def set_style_color_filter_dsc(self, value: 'lv_color_filter_dsc_t', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_color_filter_dsc(self._pointer, value, selector)
    ...
    def set_style_grid_column_dsc_array(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_grid_column_dsc_array(self._pointer, value, selector)
    ...
    def set_style_grid_row_dsc_array(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_grid_row_dsc_array(self._pointer, value, selector)
    ...
    def class_create_obj(self, parent: 'obj') -> 'obj':
        return _lvgl.lv_obj_class_create_obj(self._pointer, parent._pointer if parent else ffi.NULL)
    ...
    def add_event_cb(self, event_cb: 'lv_event_cb_t', filter: 'EVENT_CODE', user_data: 'None') -> 'event_dsc':
        def wrap_event_cb(original_event_cb):
            def event_cb(_e):
                e = event.__new__(event)
                e._pointer = _e
                return original_event_cb(e)
        ...
        return _lvgl.lv_obj_add_event_cb(self._pointer, event_cb_wrapper, filter.value if filter else 0, ffi.NULL if user_data is None else user_data)
    def get_event_count(self) -> 'int':
        return _lvgl.lv_obj_get_event_count(self._pointer)
    def get_event_dsc(self, index: 'int') -> 'event_dsc':
        return _lvgl.lv_obj_get_event_dsc(self._pointer, index)
    ...
    def remove_event_cb_with_user_data(self, event_cb: 'lv_event_cb_t', user_data: 'None') -> 'int':
        def wrap_event_cb(original_event_cb):
            def event_cb(_e):
                e = event.__new__(event)
                e._pointer = _e
    ...
    def set_user_data(self, user_data: 'None') -> 'None':
    ...
    def get_group(self) -> 'group':
        return _lvgl.lv_obj_get_group(self._pointer)
    def get_user_data(self) -> 'None':
        return _lvgl.lv_obj_get_user_data(self._pointer)
    ...
    def get_class(self) -> 'obj_class':
        return _lvgl.lv_obj_get_class(self._pointer)
    ...
    def bind_flag_if_eq(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_eq(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_flag_if_not_eq(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_not_eq(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_flag_if_gt(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_gt(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_flag_if_ge(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_ge(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_flag_if_lt(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_lt(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_flag_if_le(self, subject: 'subject', flag: 'OBJ_FLAG', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_flag_if_le(self._pointer, subject._pointer if subject else ffi.NULL, flag.value if flag else 0, ref_value)
    def bind_state_if_eq(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_eq(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_state_if_not_eq(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_not_eq(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_state_if_gt(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_gt(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_state_if_ge(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_ge(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_state_if_lt(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_lt(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_state_if_le(self, subject: 'subject', state: 'lv_state_t', ref_value: 'int') -> 'observer':
        return _lvgl.lv_obj_bind_state_if_le(self._pointer, subject._pointer if subject else ffi.NULL, state, ref_value)
    def bind_checked(self, subject: 'subject') -> 'observer':
        return _lvgl.lv_obj_bind_checked(self._pointer, subject._pointer if subject else ffi.NULL)
    ...
    def get_style_bg_grad(self, part: 'lv_part_t') -> 'grad_dsc':
        return _lvgl.lv_obj_get_style_bg_grad(self._pointer, part)
    ...
    def get_style_text_font(self, part: 'lv_part_t') -> 'font':
        return _lvgl.lv_obj_get_style_text_font(self._pointer, part)
    ...
    def get_style_anim(self, part: 'lv_part_t') -> 'anim':
        return _lvgl.lv_obj_get_style_anim(self._pointer, part)
    ...
    def get_style_transition(self, part: 'lv_part_t') -> 'style_transition_dsc':
        return _lvgl.lv_obj_get_style_transition(self._pointer, part)
    ...
    def set_style_pad_all(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_pad_all(self._pointer, value, selector)
    def set_style_pad_hor(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_pad_hor(self._pointer, value, selector)
    def set_style_pad_ver(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_pad_ver(self._pointer, value, selector)
    def set_style_margin_all(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_margin_all(self._pointer, value, selector)
    def set_style_margin_hor(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_margin_hor(self._pointer, value, selector)
    def set_style_margin_ver(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_margin_ver(self._pointer, value, selector)
    def set_style_pad_gap(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_pad_gap(self._pointer, value, selector)
    def set_style_size(self, width: 'int', height: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_size(self._pointer, width, height, selector)
    def set_style_transform_scale(self, value: 'int', selector: 'lv_style_selector_t') -> 'None':
        return _lvgl.lv_obj_set_style_transform_scale(self._pointer, value, selector)
    ...
    def move_foreground(self) -> 'None':
        return _lvgl.lv_obj_move_foreground(self._pointer)
    def move_background(self) -> 'None':
        return _lvgl.lv_obj_move_background(self._pointer)
...
class win(obj):
    ...
    def add_title(self, txt: 'str') -> 'obj':
        return _lvgl.lv_win_add_title(self._pointer, txt.encode('utf-8'))
    def add_button(self, icon: 'None', btn_w: 'int') -> 'obj':
        return _lvgl.lv_win_add_button(self._pointer, ffi.NULL if icon is None else icon, btn_w)
    def get_header(self) -> 'obj':
        return _lvgl.lv_win_get_header(self._pointer)
    def get_content(self) -> 'obj':
        return _lvgl.lv_win_get_content(self._pointer)
...
class timer:
    ...
    def get_next(self) -> 'timer':
        return _lvgl.lv_timer_get_next(self._pointer)
    def get_user_data(self) -> 'None':
        return _lvgl.lv_timer_get_user_data(self._pointer)
...
class tileview(obj):
    ...
    def add_tile(self, col_id: 'int', row_id: 'int', dir: 'DIR') -> 'obj':
        return _lvgl.lv_tileview_add_tile(self._pointer, col_id, row_id, dir.value if dir else 0)
    ...
    def get_tile_active(self) -> 'obj':
        return _lvgl.lv_tileview_get_tile_active(self._pointer)
...
class theme:
    ...
    def set_apply_cb(self, apply_cb: 'lv_theme_apply_cb_t') -> 'None':
        def wrap_apply_cb(original_apply_cb):
            def apply_cb(_t0, _o0):
                ...
                o0 = obj.__new__(obj)
                o0._pointer = _o0
                return original_apply_cb(t0, o0)
    ...
    def get_font_small(self) -> 'font':
        return _lvgl.lv_theme_get_font_small(self._pointer)
    def get_font_normal(self) -> 'font':
        return _lvgl.lv_theme_get_font_normal(self._pointer)
    def get_font_large(self) -> 'font':
        return _lvgl.lv_theme_get_font_large(self._pointer)
...
class textarea(obj):
    ...
    def get_text(self) -> 'str':
        return _lvgl.lv_textarea_get_text(self._pointer)
    def get_placeholder_text(self) -> 'str':
        return _lvgl.lv_textarea_get_placeholder_text(self._pointer)
    def get_label(self) -> 'obj':
        return _lvgl.lv_textarea_get_label(self._pointer)
    ...
    def get_password_bullet(self) -> 'str':
        return _lvgl.lv_textarea_get_password_bullet(self._pointer)
    def get_one_line(self) -> 'bool':
        return _lvgl.lv_textarea_get_one_line(self._pointer)
    def get_accepted_chars(self) -> 'str':
        return _lvgl.lv_textarea_get_accepted_chars(self._pointer)
...
class tabview(obj):
    ...
    def add_tab(self, name: 'str') -> 'obj':
        return _lvgl.lv_tabview_add_tab(self._pointer, name.encode('utf-8'))
    ...
    def get_content(self) -> 'obj':
        return _lvgl.lv_tabview_get_content(self._pointer)
    def get_tab_bar(self) -> 'obj':
        return _lvgl.lv_tabview_get_tab_bar(self._pointer)
...
class table(obj):
    ...
    def set_cell_user_data(self, row: 'int', col: 'int', user_data: 'None') -> 'None':
    ...
    def get_cell_value(self, row: 'int', col: 'int') -> 'str':
        return _lvgl.lv_table_get_cell_value(self._pointer, row, col)
    ...
    def get_selected_cell(self, row: 'int', col: 'int') -> 'None':
        return _lvgl.lv_table_get_selected_cell(self._pointer, row, col)
    def get_cell_user_data(self, row: 'int', col: 'int') -> 'None':
        return _lvgl.lv_table_get_cell_user_data(self._pointer, row, col)
...
class subject:
    ...
    def get_string(self) -> 'str':
        return _lvgl.lv_subject_get_string(self._pointer)
    def get_previous_string(self) -> 'str':
        return _lvgl.lv_subject_get_previous_string(self._pointer)
    ...
    def init_group(self, list: 'lv_subject_t', list_len: 'int') -> 'None':
        return _lvgl.lv_subject_init_group(self._pointer, list, list_len)
    def deinit(self) -> 'None':
        return _lvgl.lv_subject_deinit(self._pointer)
    def get_group_element(self, index: 'int') -> 'subject':
        return _lvgl.lv_subject_get_group_element(self._pointer, index)
    def add_observer(self, observer_cb: 'lv_observer_cb_t', user_data: 'None') -> 'observer':
        def wrap_observer_cb(original_observer_cb):
            def observer_cb(_observer, _subject):
                ...
                return original_observer_cb(observer, subject)
        ...
        return _lvgl.lv_subject_add_observer(self._pointer, observer_cb_wrapper, ffi.NULL if user_data is None else user_data)
    def add_observer_obj(self, observer_cb: 'lv_observer_cb_t', obj: 'obj', user_data: 'None') -> 'observer':
        def wrap_observer_cb(original_observer_cb):
            def observer_cb(_observer, _subject):
                observer = observer.__new__(observer)
                observer._pointer = _observer
        ...
        observer_cb_wrapper = wrap_observer_cb(observer_cb)
        self._callbacks[observer_cb] = observer_cb_wrapper
        return _lvgl.lv_subject_add_observer_obj(self._pointer, observer_cb_wrapper, obj._pointer if obj else ffi.NULL, ffi.NULL if user_data is None else user_data)
    def add_observer_with_target(self, observer_cb: 'lv_observer_cb_t', target: 'None', user_data: 'None') -> 'observer':
        def wrap_observer_cb(original_observer_cb):
            def observer_cb(_observer, _subject):
                observer = observer.__new__(observer)
                observer._pointer = _observer
        ...
        observer_cb_wrapper = wrap_observer_cb(observer_cb)
        self._callbacks[observer_cb] = observer_cb_wrapper
        return _lvgl.lv_subject_add_observer_with_target(self._pointer, observer_cb_wrapper, ffi.NULL if target is None else target, ffi.NULL if user_data is None else user_data)
...
class style_transition_dsc:
    ...
    def init(self, props: 'lv_style_prop_t', path_cb: 'lv_anim_path_cb_t', time: 'int', delay: 'int', user_data: 'None') -> 'None':
        ...
        return _lvgl.lv_style_transition_dsc_init(self._pointer, props, path_cb_wrapper, time, delay, ffi.NULL if user_data is None else user_data)
...
class style:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_style_init(self._pointer)
    def reset(self) -> 'None':
    ...
    def get_prop(self, prop: 'lv_style_prop_t', value: 'lv_style_value_t') -> 'lv_style_res_t':
        return _lvgl.lv_style_get_prop(self._pointer, prop, value)
    ...
    def set_color_filter_dsc(self, value: 'lv_color_filter_dsc_t') -> 'None':
        return _lvgl.lv_style_set_color_filter_dsc(self._pointer, value)
    ...
    def set_grid_column_dsc_array(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_grid_column_dsc_array(self._pointer, value)
    ...
    def set_grid_row_dsc_array(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_grid_row_dsc_array(self._pointer, value)
    ...
    def get_prop_inlined(self, prop: 'lv_style_prop_t', value: 'lv_style_value_t') -> 'lv_style_res_t':
        return _lvgl.lv_style_get_prop_inlined(self._pointer, prop, value)
    def set_size(self, width: 'int', height: 'int') -> 'None':
        return _lvgl.lv_style_set_size(self._pointer, width, height)
    def set_pad_all(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_pad_all(self._pointer, value)
    def set_pad_hor(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_pad_hor(self._pointer, value)
    def set_pad_ver(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_pad_ver(self._pointer, value)
    def set_pad_gap(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_pad_gap(self._pointer, value)
    def set_margin_hor(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_margin_hor(self._pointer, value)
    def set_margin_ver(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_margin_ver(self._pointer, value)
    def set_margin_all(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_margin_all(self._pointer, value)
    def set_transform_scale(self, value: 'int') -> 'None':
        return _lvgl.lv_style_set_transform_scale(self._pointer, value)
...
class spangroup(obj):
    ...
    def add_span(self) -> 'span':
        return _lvgl.lv_spangroup_add_span(self._pointer)
    ...
    def get_child(self, id: 'int') -> 'span':
        return _lvgl.lv_spangroup_get_child(self._pointer, id)
    ...
    def get_span_coords(self, span: 'span') -> 'span_coords':
        return _lvgl.lv_spangroup_get_span_coords(self._pointer, span._pointer if span else ffi.NULL)
    def get_span_by_point(self, point: 'point') -> 'span':
        return _lvgl.lv_spangroup_get_span_by_point(self._pointer, point._pointer if point else ffi.NULL)
...
class span:
    ...
    def get_style(self) -> 'style':
        return _lvgl.lv_span_get_style(self._pointer)
    def get_text(self) -> 'str':
        return _lvgl.lv_span_get_text(self._pointer)
...
class slider(obj):
    ...
    def bind_value(self, subject: 'subject') -> 'observer':
        return _lvgl.lv_slider_bind_value(self._pointer, subject._pointer if subject else ffi.NULL)
...
class scale(obj):
    ...
    def set_text_src(self, txt_src: 'str') -> 'None':
        return _lvgl.lv_scale_set_text_src(self._pointer, txt_src)
    ...
    def add_section(self) -> 'scale_section':
        return _lvgl.lv_scale_add_section(self._pointer)
...
class roller(obj):
    ...
    def get_options(self) -> 'str':
        return _lvgl.lv_roller_get_options(self._pointer)
    def get_option_count(self) -> 'int':
        return _lvgl.lv_roller_get_option_count(self._pointer)
    def bind_value(self, subject: 'subject') -> 'observer':
        return _lvgl.lv_roller_bind_value(self._pointer, subject._pointer if subject else ffi.NULL)
...
class rb:
    ...
    def init(self, compare: 'lv_rb_compare_t', node_size: 'size_t') -> 'bool':
        def wrap_compare(original_compare):
            def compare(_a, _b):
                a = _a
                b = _b
                return original_compare(a, b)
            return ffi.callback('lv_rb_compare_res_t (*)(void*, void*)', compare)
        compare_wrapper = wrap_compare(compare)
        self._callbacks[compare] = compare_wrapper
        return _lvgl.lv_rb_init(self._pointer, compare_wrapper, node_size)
    def insert(self, key: 'None') -> 'rb_node':
        return _lvgl.lv_rb_insert(self._pointer, ffi.NULL if key is None else key)
    def find(self, key: 'None') -> 'rb_node':
        return _lvgl.lv_rb_find(self._pointer, ffi.NULL if key is None else key)
    ...
    def minimum(self) -> 'rb_node':
        return _lvgl.lv_rb_minimum(self._pointer)
    def maximum(self) -> 'rb_node':
        return _lvgl.lv_rb_maximum(self._pointer)
    def minimum_from(self) -> 'rb_node':
        return _lvgl.lv_rb_minimum_from(self._pointer)
    def maximum_from(self) -> 'rb_node':
        return _lvgl.lv_rb_maximum_from(self._pointer)
...
class qrcode(obj):
    ...
    def update(self, data: 'None', data_len: 'int') -> 'lv_result_t':
        return _lvgl.lv_qrcode_update(self._pointer, ffi.NULL if data is None else data, data_len)
...
class point:
    ...
    def from_precise(self) -> 'point':
        return _lvgl.lv_point_from_precise(self._pointer)
    def to_precise(self) -> 'point_precise':
        return _lvgl.lv_point_to_precise(self._pointer)
...
class observer:
    ...
    def get_target_obj(self) -> 'obj':
        return _lvgl.lv_observer_get_target_obj(self._pointer)
    def get_user_data(self) -> 'None':
        return _lvgl.lv_observer_get_user_data(self._pointer)
...
class msgbox(obj):
    ...
    def add_title(self, title: 'str') -> 'obj':
        return _lvgl.lv_msgbox_add_title(self._pointer, title.encode('utf-8'))
    def add_header_button(self, icon: 'None') -> 'obj':
        return _lvgl.lv_msgbox_add_header_button(self._pointer, ffi.NULL if icon is None else icon)
    def add_text(self, text: 'str') -> 'obj':
        return _lvgl.lv_msgbox_add_text(self._pointer, text.encode('utf-8'))
    def add_footer_button(self, text: 'str') -> 'obj':
        return _lvgl.lv_msgbox_add_footer_button(self._pointer, text.encode('utf-8'))
    def add_close_button(self) -> 'obj':
        return _lvgl.lv_msgbox_add_close_button(self._pointer)
    def get_header(self) -> 'obj':
        return _lvgl.lv_msgbox_get_header(self._pointer)
    def get_footer(self) -> 'obj':
        return _lvgl.lv_msgbox_get_footer(self._pointer)
    def get_content(self) -> 'obj':
        return _lvgl.lv_msgbox_get_content(self._pointer)
    def get_title(self) -> 'obj':
        return _lvgl.lv_msgbox_get_title(self._pointer)
    def close(self) -> 'None':
...
class menu(obj):
    ...
    def cont_create(self) -> 'obj':
        return _lvgl.lv_menu_cont_create(self._pointer)
    def section_create(self) -> 'obj':
        return _lvgl.lv_menu_section_create(self._pointer)
    def separator_create(self) -> 'obj':
        return _lvgl.lv_menu_separator_create(self._pointer)
    ...
    def get_cur_main_page(self) -> 'obj':
        return _lvgl.lv_menu_get_cur_main_page(self._pointer)
    def get_cur_sidebar_page(self) -> 'obj':
        return _lvgl.lv_menu_get_cur_sidebar_page(self._pointer)
    def get_main_header(self) -> 'obj':
        return _lvgl.lv_menu_get_main_header(self._pointer)
    def get_main_header_back_button(self) -> 'obj':
        return _lvgl.lv_menu_get_main_header_back_button(self._pointer)
    def get_sidebar_header(self) -> 'obj':
        return _lvgl.lv_menu_get_sidebar_header(self._pointer)
    def get_sidebar_header_back_button(self) -> 'obj':
        return _lvgl.lv_menu_get_sidebar_header_back_button(self._pointer)
...
class line(obj):
    ...
    def get_points_mutable(self) -> 'point_precise':
        return _lvgl.lv_line_get_points_mutable(self._pointer)
...
class layer:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_layer_init(self._pointer)
    def reset(self) -> 'None':
...
class label(obj):
    ...
    def get_text(self) -> 'str':
        return _lvgl.lv_label_get_text(self._pointer)
    ...
    def bind_text(self, subject: 'subject', fmt: 'str') -> 'observer':
        return _lvgl.lv_label_bind_text(self._pointer, subject._pointer if subject else ffi.NULL, fmt.encode('utf-8'))
...
class keyboard(obj):
    ...
    def set_map(self, mode: 'KEYBOARD_MODE', map: 'str', ctrl_map: 'lv_buttonmatrix_ctrl_t') -> 'None':
        return _lvgl.lv_keyboard_set_map(self._pointer, mode.value if mode else 0, map, ctrl_map)
    def get_textarea(self) -> 'obj':
        return _lvgl.lv_keyboard_get_textarea(self._pointer)
    ...
    def get_map_array(self) -> 'str':
        return _lvgl.lv_keyboard_get_map_array(self._pointer)
    ...
    def get_button_text(self, btn_id: 'int') -> 'str':
        return _lvgl.lv_keyboard_get_button_text(self._pointer, btn_id)
    ...
    def inspect(self, inspect_cb: 'lv_iter_inspect_cb') -> 'None':
        def wrap_inspect_cb(original_inspect_cb):
            def inspect_cb(_elem):
                elem = _elem
                return original_inspect_cb(elem)
...
class indev:
    ...
    def get_next(self) -> 'indev':
        return _lvgl.lv_indev_get_next(self._pointer)
    def read(self) -> 'None':
    ...
    def set_read_cb(self, read_cb: 'lv_indev_read_cb_t') -> 'None':
        def wrap_read_cb(original_read_cb):
            def read_cb(_indev, _data):
                ...
                data._pointer = _data
                return original_read_cb(indev, data)
    ...
    def get_group(self) -> 'group':
        return _lvgl.lv_indev_get_group(self._pointer)
    def get_display(self) -> 'display':
        return _lvgl.lv_indev_get_display(self._pointer)
    def get_user_data(self) -> 'None':
        return _lvgl.lv_indev_get_user_data(self._pointer)
    ...
    def set_button_points(self, points: 'lv_point_t') -> 'None':
        return _lvgl.lv_indev_set_button_points(self._pointer, points)
    ...
    def get_scroll_obj(self) -> 'obj':
        return _lvgl.lv_indev_get_scroll_obj(self._pointer)
    ...
    def search_obj(self, point: 'point') -> 'obj':
        return _lvgl.lv_indev_search_obj(self._pointer, point._pointer if point else ffi.NULL)
    def add_event_cb(self, event_cb: 'lv_event_cb_t', filter: 'EVENT_CODE', user_data: 'None') -> 'None':
        def wrap_event_cb(original_event_cb):
            def event_cb(_e):
                e = event.__new__(event)
                e._pointer = _e
    ...
    def get_event_dsc(self, index: 'int') -> 'event_dsc':
        return _lvgl.lv_indev_get_event_dsc(self._pointer, index)
    def remove_event(self, index: 'int') -> 'bool':
...
class image_decoder:
    ...
    def get_next(self) -> 'image_decoder':
        return _lvgl.lv_image_decoder_get_next(self._pointer)
    ...
    def set_close_cb(self, close_cb: 'lv_image_decoder_close_f_t') -> 'None':
        def wrap_close_cb(original_close_cb):
            def close_cb(_decoder, _dsc):
                ...
                dsc = image_decoder_dsc.__new__(image_decoder_dsc)
                dsc._pointer = _dsc
                return original_close_cb(decoder, dsc)
    ...
    def add_to_cache(self, search_key: 'image_cache_data', decoded: 'draw_buf', user_data: 'None') -> 'cache_entry':
        return _lvgl.lv_image_decoder_add_to_cache(self._pointer, search_key._pointer if search_key else ffi.NULL, decoded._pointer if decoded else ffi.NULL, ffi.NULL if user_data is None else user_data)
    def post_process(self, decoded: 'draw_buf') -> 'draw_buf':
        return _lvgl.lv_image_decoder_post_process(self._pointer, decoded._pointer if decoded else ffi.NULL)
...
class image(obj):
    ...
    def get_bitmap_map_src(self) -> 'image_dsc':
        return _lvgl.lv_image_get_bitmap_map_src(self._pointer)
...
class group:
    ...
    def get_focused(self) -> 'obj':
        return _lvgl.lv_group_get_focused(self._pointer)
    ...
    def get_obj_by_index(self, index: 'int') -> 'obj':
        return _lvgl.lv_group_get_obj_by_index(self._pointer, index)
...
class event_dsc:
    ...
    def get_user_data(self) -> 'None':
        return _lvgl.lv_event_dsc_get_user_data(self._pointer)
...
class event:
    ...
    def add(self, cb: 'lv_event_cb_t', filter: 'EVENT_CODE', user_data: 'None') -> 'event_dsc':
        def wrap_cb(original_cb):
            def cb(_e):
                e = event.__new__(event)
                e._pointer = _e
                return original_cb(e)
            return ffi.callback('void (*)(lv_event_t*)', cb)
        cb_wrapper = wrap_cb(cb)
        self._callbacks[cb] = cb_wrapper
        return _lvgl.lv_event_add(self._pointer, cb_wrapper, filter.value if filter else 0, ffi.NULL if user_data is None else user_data)
    ...
    def get_dsc(self, index: 'int') -> 'event_dsc':
        return _lvgl.lv_event_get_dsc(self._pointer, index)
    ...
    def get_user_data(self) -> 'None':
        return _lvgl.lv_event_get_user_data(self._pointer)
    ...
    def get_invalidated_area(self) -> 'area':
        return _lvgl.lv_event_get_invalidated_area(self._pointer)
    def get_current_target_obj(self) -> 'obj':
        return _lvgl.lv_event_get_current_target_obj(self._pointer)
    def get_target_obj(self) -> 'obj':
        return _lvgl.lv_event_get_target_obj(self._pointer)
    def get_indev(self) -> 'indev':
        return _lvgl.lv_event_get_indev(self._pointer)
    def get_layer(self) -> 'layer':
        return _lvgl.lv_event_get_layer(self._pointer)
    def get_old_size(self) -> 'area':
        return _lvgl.lv_event_get_old_size(self._pointer)
    def get_key(self) -> 'int':
    ...
    def get_scroll_anim(self) -> 'anim':
        return _lvgl.lv_event_get_scroll_anim(self._pointer)
    ...
    def get_self_size_info(self) -> 'point':
        return _lvgl.lv_event_get_self_size_info(self._pointer)
    def get_hit_test_info(self) -> 'hit_test_info':
        return _lvgl.lv_event_get_hit_test_info(self._pointer)
    def get_cover_area(self) -> 'area':
        return _lvgl.lv_event_get_cover_area(self._pointer)
    ...
    def get_draw_task(self) -> 'draw_task':
        return _lvgl.lv_event_get_draw_task(self._pointer)
...
class dropdown(obj):
    ...
    def get_list(self) -> 'obj':
        return _lvgl.lv_dropdown_get_list(self._pointer)
    def get_text(self) -> 'str':
        return _lvgl.lv_dropdown_get_text(self._pointer)
    def get_options(self) -> 'str':
        return _lvgl.lv_dropdown_get_options(self._pointer)
    def get_selected(self) -> 'int':
    ...
    def get_symbol(self) -> 'str':
        return _lvgl.lv_dropdown_get_symbol(self._pointer)
    ...
    def bind_value(self, subject: 'subject') -> 'observer':
        return _lvgl.lv_dropdown_bind_value(self._pointer, subject._pointer if subject else ffi.NULL)
    ...
    def draw_letter(self, dsc: 'draw_glyph_dsc', pos: 'point', font: 'font', letter: 'int', cb: 'lv_draw_glyph_cb_t') -> 'None':
        def wrap_cb(original_cb):
            def cb(_t, _dsc, _fill_dsc, _fill_area):
                ...
                return original_cb(t, dsc, fill_dsc, fill_area)
...
class draw_triangle_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_triangle_dsc_init(self._pointer)
...
class draw_task:
    ...
    def get_fill_dsc(self) -> 'draw_fill_dsc':
        return _lvgl.lv_draw_task_get_fill_dsc(self._pointer)
    def get_border_dsc(self) -> 'draw_border_dsc':
        return _lvgl.lv_draw_task_get_border_dsc(self._pointer)
    def get_box_shadow_dsc(self) -> 'draw_box_shadow_dsc':
        return _lvgl.lv_draw_task_get_box_shadow_dsc(self._pointer)
    def get_label_dsc(self) -> 'draw_label_dsc':
        return _lvgl.lv_draw_task_get_label_dsc(self._pointer)
    def get_image_dsc(self) -> 'draw_image_dsc':
        return _lvgl.lv_draw_task_get_image_dsc(self._pointer)
    def get_line_dsc(self) -> 'draw_line_dsc':
        return _lvgl.lv_draw_task_get_line_dsc(self._pointer)
    def get_arc_dsc(self) -> 'draw_arc_dsc':
        return _lvgl.lv_draw_task_get_arc_dsc(self._pointer)
    def get_triangle_dsc(self) -> 'draw_triangle_dsc':
        return _lvgl.lv_draw_task_get_triangle_dsc(self._pointer)
...
class draw_rect_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_rect_dsc_init(self._pointer)
...
class draw_line_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_line_dsc_init(self._pointer)
...
class draw_letter_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_letter_dsc_init(self._pointer)
...
class draw_label_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_label_dsc_init(self._pointer)
...
class draw_image_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_image_dsc_init(self._pointer)
...
class draw_glyph_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_glyph_dsc_init(self._pointer)
...
class draw_fill_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_fill_dsc_init(self._pointer)
...
class draw_buf_handlers:
    ...
    def init(self, buf_malloc_cb: 'lv_draw_buf_malloc_cb', buf_free_cb: 'lv_draw_buf_free_cb', align_pointer_cb: 'lv_draw_buf_align_cb', invalidate_cache_cb: 'lv_draw_buf_cache_operation_cb', flush_cache_cb: 'lv_draw_buf_cache_operation_cb', width_to_stride_cb: 'lv_draw_buf_width_to_stride_cb') -> 'None':
        def wrap_buf_malloc_cb(original_buf_malloc_cb):
            def buf_malloc_cb(_size, _color_format):
                size = _size
                color_format = _color_format
                return original_buf_malloc_cb(size, color_format)
            return ffi.callback('void* (*)(size_t, lv_color_format_t)', buf_malloc_cb)
        buf_malloc_cb_wrapper = wrap_buf_malloc_cb(buf_malloc_cb)
        self._callbacks[buf_malloc_cb] = buf_malloc_cb_wrapper
        def wrap_buf_free_cb(original_buf_free_cb):
            def buf_free_cb(_draw_buf):
                draw_buf = _draw_buf
                return original_buf_free_cb(draw_buf)
            return ffi.callback('void (*)(void*)', buf_free_cb)
        buf_free_cb_wrapper = wrap_buf_free_cb(buf_free_cb)
        self._callbacks[buf_free_cb] = buf_free_cb_wrapper
        def wrap_align_pointer_cb(original_align_pointer_cb):
            def align_pointer_cb(_buf, _color_format):
                buf = _buf
                color_format = _color_format
                return original_align_pointer_cb(buf, color_format)
            return ffi.callback('void* (*)(void*, lv_color_format_t)', align_pointer_cb)
        align_pointer_cb_wrapper = wrap_align_pointer_cb(align_pointer_cb)
        self._callbacks[align_pointer_cb] = align_pointer_cb_wrapper
        def wrap_invalidate_cache_cb(original_invalidate_cache_cb):
            def invalidate_cache_cb(_draw_buf, _area):
                draw_buf = draw_buf.__new__(draw_buf)
                draw_buf._pointer = _draw_buf
                area = area.__new__(area)
                area._pointer = _area
                return original_invalidate_cache_cb(draw_buf, area)
            return ffi.callback('void (*)(lv_draw_buf_t*, lv_area_t*)', invalidate_cache_cb)
        invalidate_cache_cb_wrapper = wrap_invalidate_cache_cb(invalidate_cache_cb)
        self._callbacks[invalidate_cache_cb] = invalidate_cache_cb_wrapper
        def wrap_flush_cache_cb(original_flush_cache_cb):
            def flush_cache_cb(_draw_buf, _area):
                draw_buf = draw_buf.__new__(draw_buf)
                draw_buf._pointer = _draw_buf
                area = area.__new__(area)
                area._pointer = _area
                return original_flush_cache_cb(draw_buf, area)
            return ffi.callback('void (*)(lv_draw_buf_t*, lv_area_t*)', flush_cache_cb)
        flush_cache_cb_wrapper = wrap_flush_cache_cb(flush_cache_cb)
        self._callbacks[flush_cache_cb] = flush_cache_cb_wrapper
        def wrap_width_to_stride_cb(original_width_to_stride_cb):
            def width_to_stride_cb(_w, _color_format):
                w = _w
                color_format = _color_format
                return original_width_to_stride_cb(w, color_format)
            return ffi.callback('uint32_t (*)(uint32_t, lv_color_format_t)', width_to_stride_cb)
        width_to_stride_cb_wrapper = wrap_width_to_stride_cb(width_to_stride_cb)
        self._callbacks[width_to_stride_cb] = width_to_stride_cb_wrapper
        return _lvgl.lv_draw_buf_handlers_init(self._pointer, buf_malloc_cb_wrapper, buf_free_cb_wrapper, align_pointer_cb_wrapper, invalidate_cache_cb_wrapper, flush_cache_cb_wrapper, width_to_stride_cb_wrapper)
...
class draw_buf:
    ...
    def create_ex(self, w: 'int', h: 'int', cf: 'COLOR_FORMAT', stride: 'int') -> 'draw_buf':
        return _lvgl.lv_draw_buf_create_ex(self._pointer, w, h, cf.value if cf else 0, stride)
    def dup(self) -> 'draw_buf':
        return _lvgl.lv_draw_buf_dup(self._pointer)
    def dup_ex(self, draw_buf: 'draw_buf') -> 'draw_buf':
        return _lvgl.lv_draw_buf_dup_ex(self._pointer, draw_buf._pointer if draw_buf else ffi.NULL)
    def init(self, w: 'int', h: 'int', cf: 'COLOR_FORMAT', stride: 'int', data: 'None', data_size: 'int') -> 'lv_result_t':
        return _lvgl.lv_draw_buf_init(self._pointer, w, h, cf.value if cf else 0, stride, ffi.NULL if data is None else data, data_size)
    def reshape(self, cf: 'COLOR_FORMAT', w: 'int', h: 'int', stride: 'int') -> 'draw_buf':
        return _lvgl.lv_draw_buf_reshape(self._pointer, cf.value if cf else 0, w, h, stride)
    def destroy(self) -> 'None':
...
class draw_box_shadow_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_box_shadow_dsc_init(self._pointer)
...
class draw_border_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_border_dsc_init(self._pointer)
...
class draw_arc_dsc:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_draw_arc_dsc_init(self._pointer)
...
class display:
    ...
    def get_next(self) -> 'display':
        return _lvgl.lv_display_get_next(self._pointer)
    ...
    def set_flush_cb(self, flush_cb: 'lv_display_flush_cb_t') -> 'None':
        def wrap_flush_cb(original_flush_cb):
            def flush_cb(_disp, _area, _px_map):
                ...
                area._pointer = _area
                px_map = _px_map
                return original_flush_cb(disp, area, px_map)
    ...
    def get_screen_active(self) -> 'obj':
        return _lvgl.lv_display_get_screen_active(self._pointer)
    def get_screen_prev(self) -> 'obj':
        return _lvgl.lv_display_get_screen_prev(self._pointer)
    def get_layer_top(self) -> 'obj':
        return _lvgl.lv_display_get_layer_top(self._pointer)
    def get_layer_sys(self) -> 'obj':
        return _lvgl.lv_display_get_layer_sys(self._pointer)
    def get_layer_bottom(self) -> 'obj':
        return _lvgl.lv_display_get_layer_bottom(self._pointer)
    def add_event_cb(self, event_cb: 'lv_event_cb_t', filter: 'EVENT_CODE', user_data: 'None') -> 'None':
        def wrap_event_cb(original_event_cb):
            def event_cb(_e):
                e = event.__new__(event)
    ...
    def get_event_dsc(self, index: 'int') -> 'event_dsc':
        return _lvgl.lv_display_get_event_dsc(self._pointer, index)
    ...
    def get_theme(self) -> 'theme':
        return _lvgl.lv_display_get_theme(self._pointer)
    ...
    def get_refr_timer(self) -> 'timer':
        return _lvgl.lv_display_get_refr_timer(self._pointer)
    ...
    def get_user_data(self) -> 'None':
        return _lvgl.lv_display_get_user_data(self._pointer)
    def get_driver_data(self) -> 'None':
        return _lvgl.lv_display_get_driver_data(self._pointer)
    def get_buf_active(self) -> 'draw_buf':
        return _lvgl.lv_display_get_buf_active(self._pointer)
...
class circle_buf:
    ...
    def create_from_buf(self, capacity: 'int', element_size: 'int') -> 'circle_buf':
        return _lvgl.lv_circle_buf_create_from_buf(self._pointer, capacity, element_size)
    def create_from_array(self) -> 'circle_buf':
        return _lvgl.lv_circle_buf_create_from_array(self._pointer)
    ...
    def fill(self, count: 'int', fill_cb: 'lv_circle_buf_fill_cb_t', user_data: 'None') -> 'int':
...
class checkbox(obj):
    ...
    def get_text(self) -> 'str':
        return _lvgl.lv_checkbox_get_text(self._pointer)
...
class chart(obj):
    ...
    def add_series(self, color: 'lv_color_t', axis: 'CHART_AXIS') -> 'chart_series':
        return _lvgl.lv_chart_add_series(self._pointer, color, axis.value if axis else 0)
    ...
    def get_series_next(self, ser: 'chart_series') -> 'chart_series':
        return _lvgl.lv_chart_get_series_next(self._pointer, ser._pointer if ser else ffi.NULL)
    def add_cursor(self, color: 'lv_color_t', dir: 'DIR') -> 'chart_cursor':
        return _lvgl.lv_chart_add_cursor(self._pointer, color, dir.value if dir else 0)
    ...
    def get_cursor_point(self, cursor: 'chart_cursor') -> 'point':
        return _lvgl.lv_chart_get_cursor_point(self._pointer, cursor._pointer if cursor else ffi.NULL)
    ...
    def set_series_values(self, ser: 'chart_series', values: 'int', values_cnt: 'size_t') -> 'None':
        return _lvgl.lv_chart_set_series_values(self._pointer, ser._pointer if ser else ffi.NULL, values, values_cnt)
    def set_series_values2(self, ser: 'chart_series', x_values: 'int', y_values: 'int', values_cnt: 'size_t') -> 'None':
        return _lvgl.lv_chart_set_series_values2(self._pointer, ser._pointer if ser else ffi.NULL, x_values, y_values, values_cnt)
    ...
    def set_series_ext_y_array(self, ser: 'chart_series', array: 'int') -> 'None':
        return _lvgl.lv_chart_set_series_ext_y_array(self._pointer, ser._pointer if ser else ffi.NULL, array)
    def set_series_ext_x_array(self, ser: 'chart_series', array: 'int') -> 'None':
        return _lvgl.lv_chart_set_series_ext_x_array(self._pointer, ser._pointer if ser else ffi.NULL, array)
...
class calendar(obj):
    ...
    def set_highlighted_dates(self, highlighted: 'lv_calendar_date_t', date_num: 'size_t') -> 'None':
        return _lvgl.lv_calendar_set_highlighted_dates(self._pointer, highlighted, date_num)
    def set_day_names(self, day_names: 'str') -> 'None':
        return _lvgl.lv_calendar_set_day_names(self._pointer, day_names)
    def get_btnmatrix(self) -> 'obj':
        return _lvgl.lv_calendar_get_btnmatrix(self._pointer)
    def get_today_date(self) -> 'calendar_date':
        return _lvgl.lv_calendar_get_today_date(self._pointer)
    def get_showed_date(self) -> 'calendar_date':
        return _lvgl.lv_calendar_get_showed_date(self._pointer)
    def get_highlighted_dates(self) -> 'calendar_date':
        return _lvgl.lv_calendar_get_highlighted_dates(self._pointer)
    ...
    def header_arrow_create(self) -> 'obj':
        return _lvgl.lv_calendar_header_arrow_create(self._pointer)
    def header_dropdown_create(self) -> 'obj':
        return _lvgl.lv_calendar_header_dropdown_create(self._pointer)
...
class buttonmatrix(obj):
    ...
    def set_map(self, map: 'str') -> 'None':
        return _lvgl.lv_buttonmatrix_set_map(self._pointer, map)
    def set_ctrl_map(self, ctrl_map: 'lv_buttonmatrix_ctrl_t') -> 'None':
        return _lvgl.lv_buttonmatrix_set_ctrl_map(self._pointer, ctrl_map)
    ...
    def get_map(self) -> 'str':
        return _lvgl.lv_buttonmatrix_get_map(self._pointer)
    def get_selected_button(self) -> 'int':
        return _lvgl.lv_buttonmatrix_get_selected_button(self._pointer)
    def get_button_text(self, btn_id: 'int') -> 'str':
        return _lvgl.lv_buttonmatrix_get_button_text(self._pointer, btn_id)
...
class array:
    ...
    def init(self, capacity: 'int', element_size: 'int') -> 'None':
        return _lvgl.lv_array_init(self._pointer, capacity, element_size)
...
class arc(obj):
    ...
    def bind_value(self, subject: 'subject') -> 'observer':
        return _lvgl.lv_arc_bind_value(self._pointer, subject._pointer if subject else ffi.NULL)
...
class animimg(obj):
    ...
    def set_src(self, dsc: 'None', num: 'size_t') -> 'None':
        return _lvgl.lv_animimg_set_src(self._pointer, dsc, num)
    def start(self) -> 'None':
    ...
    def get_anim(self) -> 'anim':
        return _lvgl.lv_animimg_get_anim(self._pointer)
...
class anim:
    ...
    def init(self) -> 'None':
        return _lvgl.lv_anim_init(self._pointer)
    ...
    def set_completed_cb(self, completed_cb: 'lv_anim_completed_cb_t') -> 'None':
        def wrap_completed_cb(original_completed_cb):
            def completed_cb(_a0):
                a0 = anim.__new__(anim)
                a0._pointer = _a0
                return original_completed_cb(a0)
    ...
    def start(self) -> 'anim':
        return _lvgl.lv_anim_start(self._pointer)
    ...
    def get_user_data(self) -> 'None':
        return _lvgl.lv_anim_get_user_data(self._pointer)
    ...
    def get(self, exec_cb: 'lv_anim_exec_xcb_t') -> 'anim':
        ...
        exec_cb_wrapper = wrap_exec_cb(exec_cb)
        self._callbacks[exec_cb] = exec_cb_wrapper
        return _lvgl.lv_anim_get(self._pointer, exec_cb_wrapper)
    ...
    def custom_get(self, exec_cb: 'lv_anim_custom_exec_cb_t') -> 'anim':
        ...
        exec_cb_wrapper = wrap_exec_cb(exec_cb)
        self._callbacks[exec_cb] = exec_cb_wrapper
        return _lvgl.lv_anim_custom_get(self._pointer, exec_cb_wrapper)
    def path_linear(self) -> 'int':
        return _lvgl.lv_anim_path_linear(self._pointer)
    def path_ease_in(self) -> 'int':
        return _lvgl.lv_anim_path_ease_in(self._pointer)
    def path_ease_out(self) -> 'int':
        return _lvgl.lv_anim_path_ease_out(self._pointer)
    def path_ease_in_out(self) -> 'int':
        return _lvgl.lv_anim_path_ease_in_out(self._pointer)
    def path_overshoot(self) -> 'int':
        return _lvgl.lv_anim_path_overshoot(self._pointer)
    def path_bounce(self) -> 'int':
        return _lvgl.lv_anim_path_bounce(self._pointer)
    def path_step(self) -> 'int':
        return _lvgl.lv_anim_path_step(self._pointer)
    def path_custom_bezier3(self) -> 'int':
        return _lvgl.lv_anim_path_custom_bezier3(self._pointer)
...
def timer_create(timer_xcb: 'lv_timer_cb_t', period: 'int', user_data: 'None') -> 'timer':
    def wrap_timer_xcb(original_timer_xcb):
        def timer_xcb(_t0):
            t0 = timer.__new__(timer)
            t0._pointer = _t0
            return original_timer_xcb(t0)
...
def async_call(async_xcb: 'lv_async_cb_t', user_data: 'None') -> 'lv_result_t':
    def wrap_async_xcb(original_async_xcb):
        def async_xcb(_N0):
            N0 = _N0
            return original_async_xcb(N0)
...
def async_call_cancel(async_xcb: 'lv_async_cb_t', user_data: 'None') -> 'lv_result_t':
    def wrap_async_xcb(original_async_xcb):
        def async_xcb(_N0):
            N0 = _N0
            return original_async_xcb(N0)
...
def color_premultiply(c: 'lv_color32_t') -> 'None':
    return _lvgl.lv_color_premultiply(c)
def color16_premultiply(c: 'lv_color16_t', a: 'lv_opa_t') -> 'None':
    return _lvgl.lv_color16_premultiply(c, a)
...
def color24_luminance(c: 'int') -> 'int':
    return _lvgl.lv_color24_luminance(c)
...
def color_filter_dsc_init(dsc: 'lv_color_filter_dsc_t', cb: 'lv_color_filter_cb_t') -> 'None':
    ...
    cb_wrapper = wrap_cb(cb)
    _callbacks[cb] = cb_wrapper
    return _lvgl.lv_color_filter_dsc_init(dsc, cb_wrapper)
...
def circle_buf_create(capacity: 'int', element_size: 'int') -> 'circle_buf':
    ...
    return result if result._pointer else None
def tree_walk(node: 'tree_node', mode: 'lv_tree_walk_mode_t', cb: 'lv_tree_traverse_cb_t', bcb: 'lv_tree_before_cb_t', acb: 'lv_tree_after_cb_t', user_data: 'None') -> 'bool':
    def wrap_cb(original_cb):
    ...
    def wrap_acb(original_acb):
        def acb(_node, _user_data):
            ...
            node._pointer = _node
            user_data = _user_data
            return original_acb(node, user_data)
...
def text_is_cmd(state: 'lv_text_cmd_state_t', c: 'int') -> 'bool':
    return _lvgl.lv_text_is_cmd(state, c)
def grad_init_stops(grad: 'grad_dsc', colors: 'lv_color_t', opa: 'lv_opa_t', fracs: 'int', num_stops: 'int') -> 'None':
    return _lvgl.lv_grad_init_stops(grad._pointer if grad else ffi.NULL, colors, opa, fracs, num_stops)
def grad_horizontal_init(dsc: 'grad_dsc') -> 'None':
    return _lvgl.lv_grad_horizontal_init(dsc._pointer if dsc else ffi.NULL)
def grad_vertical_init(dsc: 'grad_dsc') -> 'None':
    return _lvgl.lv_grad_vertical_init(dsc._pointer if dsc else ffi.NULL)
def layout_register(cb: 'lv_layout_update_cb_t', user_data: 'None') -> 'int':
    def wrap_cb(original_cb):
        def cb(_o0, _user_data):
            o0 = obj.__new__(obj)
            o0._pointer = _o0
            user_data = _user_data
            return original_cb(o0, user_data)
...
def event_code_get_name(code: 'EVENT_CODE') -> 'str':
    return _lvgl.lv_event_code_get_name(code.value if code else 0)
...
def list_get_button_text(list: 'obj', btn: 'obj') -> 'str':
    return _lvgl.lv_list_get_button_text(list._pointer if list else ffi.NULL, btn._pointer if btn else ffi.NULL)
...
def evdev_create(indev_type: 'INDEV_TYPE', dev_path: 'str') -> 'indev':
    ...
    return result if result._pointer else None
def evdev_discovery_start(cb: 'lv_evdev_discovery_cb_t', user_data: 'None') -> 'lv_result_t':
    def wrap_cb(original_cb):
        def cb(_indev, _type, _user_data):
            ...
            type = _type
            user_data = _user_data
            return original_cb(indev, type, user_data)
...
def windows_create_display(title: 'str', hor_res: 'int', ver_res: 'int', zoom_level: 'int', allow_dpi_override: 'bool', simulator_mode: 'bool') -> 'display':
    result = display.__new__(display)
    result._pointer = _lvgl.lv_windows_create_display(title, hor_res, ver_res, zoom_level, allow_dpi_override, simulator_mode)
    return result if result._pointer else None
...
def bidi_calculate_align(align: 'lv_text_align_t', base_dir: 'lv_base_dir_t', txt: 'str') -> 'None':
    return _lvgl.lv_bidi_calculate_align(align, base_dir, txt.encode('utf-8'))
